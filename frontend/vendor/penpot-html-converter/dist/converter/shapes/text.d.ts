...
export declare function renderParagraph(para: ParagraphNode, fillTokenName?: string, tokens?: Map<string, string>, fallbackColor?: string, typographies?: Record<string, Typography>): string;
